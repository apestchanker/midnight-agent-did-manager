...
class _Either_0 {
  alignment() {
    return _descriptor_1.alignment().concat(_descriptor_4.alignment().concat(_descriptor_7.alignment()));
  }
  fromValue(value_0) {
    return {
  ...
  toValue(value_0) {
    return _descriptor_1.toValue(value_0.is_left).concat(_descriptor_4.toValue(value_0.left).concat(_descriptor_7.toValue(value_0.right)));
  }
}
...
class _CoinPreimage_0 {
  alignment() {
    return _descriptor_12.alignment().concat(_descriptor_3.alignment().concat(_descriptor_1.alignment().concat(_descriptor_0.alignment())));
  }
  fromValue(value_0) {
    return {
  ...
  toValue(value_0) {
    return _descriptor_12.toValue(value_0.domain_sep).concat(_descriptor_3.toValue(value_0.info).concat(_descriptor_1.toValue(value_0.dataType).concat(_descriptor_0.toValue(value_0.data))));
  }
}
...
class _Maybe_0 {
  ...
  toValue(value_0) {
    return _descriptor_1.toValue(value_0.is_some).concat(_descriptor_3.toValue(value_0.value));
  }
}
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      register_initial_admin: (...args_1) => {
        if (args_1.length !== 4) {
          throw new __compactRuntime.CompactError(`register_initial_admin: expected 4 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const admin_recipient_0 = args_1[1];
        const admin_coin_nonce_0 = args_1[2];
        const admin_supply_0 = args_1[3];
        ...
        const partialProofData = {
          input: {
            value: _descriptor_4.toValue(admin_recipient_0).concat(_descriptor_0.toValue(admin_coin_nonce_0).concat(_descriptor_5.toValue(admin_supply_0))),
      ...
      mint_capability_tokens: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_3.toValue(coin_0).concat(_descriptor_0.toValue(subscription_key_0).concat(_descriptor_4.toValue(recipient_0).concat(_descriptor_0.toValue(coin_nonce_0).concat(_descriptor_5.toValue(amount_0))))),
            alignment: _descriptor_3.alignment().concat(_descriptor_0.alignment().concat(_descriptor_4.alignment().concat(_descriptor_0.alignment().concat(_descriptor_5.alignment()))))
          },
          output: undefined,
          publicTranscript: [],
          privateTranscriptOutputs: []
      ...
      gated_self_register_did: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_3.toValue(coin_0).concat(_descriptor_0.toValue(subject_nonce_0)),
      ...
      request_update_did: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_3.toValue(coin_0).concat(_descriptor_0.toValue(subject_nonce_0).concat(_descriptor_0.toValue(doc_commitment_0).concat(_descriptor_0.toValue(cap_commitment_0)))),
            alignment: _descriptor_3.alignment().concat(_descriptor_0.alignment().concat(_descriptor_0.alignment().concat(_descriptor_0.alignment())))
          },
          output: undefined,
          publicTranscript: [],
          privateTranscriptOutputs: []
      ...
      issue_did: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_3.toValue(coin_0).concat(_descriptor_0.toValue(did_key_0).concat(_descriptor_0.toValue(did_commitment_0).concat(_descriptor_0.toValue(doc_commitment_0).concat(_descriptor_0.toValue(proof_commitment_0))))),
            alignment: _descriptor_3.alignment().concat(_descriptor_0.alignment().concat(_descriptor_0.alignment().concat(_descriptor_0.alignment().concat(_descriptor_0.alignment()))))
          },
          output: undefined,
          publicTranscript: [],
          privateTranscriptOutputs: []
      ...
      grant_role: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_3.toValue(coin_0).concat(_descriptor_0.toValue(did_key_0).concat(_descriptor_0.toValue(role_0))),
      ...
      rotate_admin_tokens: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_3.toValue(coin_0).concat(_descriptor_4.toValue(new_recipient_0).concat(_descriptor_0.toValue(new_coin_nonce_0).concat(_descriptor_5.toValue(new_supply_0)))),
            alignment: _descriptor_3.alignment().concat(_descriptor_4.alignment().concat(_descriptor_0.alignment().concat(_descriptor_5.alignment())))
          },
          output: undefined,
          publicTranscript: [],
          privateTranscriptOutputs: []
      ...
      revoke_did: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_3.toValue(coin_0).concat(_descriptor_0.toValue(did_key_0)),
            alignment: _descriptor_3.alignment().concat(_descriptor_0.alignment())
          },
          output: undefined,
          publicTranscript: [],
  ...
  initialState(...args_0) {
    ...
    if (!(salt_0.buffer instanceof ArrayBuffer && salt_0.BYTES_PER_ELEMENT === 1 && salt_0.length === 32)) {
      __compactRuntime.typeError('Contract state constructor',
                                 'argument 1 (argument 2 as invoked from Typescript)',
                                 'did_registry.compact line 85 char 1',
                                 'Bytes<32>',
                                 salt_0)
    }
  ...
  _register_initial_admin_0(context,
                            partialProofData,
                            admin_recipient_0,
                            admin_coin_nonce_0,
                            admin_supply_0)
                                      ...
                                      [
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_6.toValue(2n),
                                                                                              alignment: _descriptor_6.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_4.toValue(public_recipient_0),
                                                                                              alignment: _descriptor_4.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } },
                                       { ins: { cached: true, n: 1 } }]);
                                      ...
                                      [
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(did_key_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_4.toValue(controller_0),
                                                                                              alignment: _descriptor_4.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } },
                                       { ins: { cached: true, n: 2 } }]);
    const tmp_0 = 1n;
    ...
    __compactRuntime.assert(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      ...
                                                                                      [
                                                                                       ...
                                                                                       { popeq: { cached: true,
                                                                                                  result: undefined } }]).value),
                            'DID not registered');
    __compactRuntime.assert(this._equal_5(_descriptor_6.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                    partialProofData,
                                                                                                    [
                                                                                                     { dup: { n: 0 } },
                                                                                                     { idx: { cached: false,
    ...
    __compactRuntime.assert(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      ...
                                                                                      [
                                                                                       ...
                                                                                       { popeq: { cached: true,
                                                                                                  result: undefined } }]).value),
                            'DID not registered');
    __compactRuntime.assert(this._equal_7(_descriptor_6.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                    partialProofData,
                                                                                                    [
                                                                                                     { dup: { n: 0 } },
                                                                                                     { idx: { cached: false,
  ...
  _grant_role_0(context, partialProofData, coin_0, did_key_0, role_0) {
    ...
    const target_0 = _descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
                                                                               partialProofData,
                                                                               [
                                                                                { dup: { n: 0 } },
                                                                                { idx: { cached: false,
  ...
  _revoke_did_0(context, partialProofData, coin_0, did_key_0) {
    ...
    __compactRuntime.assert(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      ...
                                                                                      [
                                                                                       ...
                                                                                       { popeq: { cached: true,
                                                                                                  result: undefined } }]).value),
                            'DID not registered');
    __compactRuntime.assert(this._equal_9(_descriptor_6.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                    partialProofData,
                                                                                                    [
                                                                                                     { dup: { n: 0 } },
                                                                                                     { idx: { cached: false,
    ...
    {
      let t_1, t_2;
      const tmp_1 = (t_1 = _descriptor_5.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                     partialProofData,
                                                                                     [
                                                                                      { dup: { n: 0 } },
                                                                                      { idx: { cached: false,
